...
# ============================================================
Assert 'col is_seckill exists'    ((Db "SHOW COLUMNS FROM product LIKE 'is_seckill'")    -match 'is_seckill')
Assert 'col seckill_stock exists' ((Db "SHOW COLUMNS FROM product LIKE 'seckill_stock'") -match 'seckill_stock')
Assert 'col seckill_price exists' ((Db "SHOW COLUMNS FROM product LIKE 'seckill_price'") -match 'seckill_price')
...
# stock=20, same user 7 rapid requests => first 5 pass, 6+ returns 429
# ============================================================
